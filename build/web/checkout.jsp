...
<html>
    <head>
        ...
        <style>
            .adlink { color: #FF0000; } /* CSS link color */
        </style>
    </head>
    <body>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <h4 class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <%
                                ...
                                out.println("</span></h4>");
                                out.println("<ul class='list-group mb-3 z-depth-1'>");
                                for (Cart c : cart) {
                                    
                                    ProductDAO proDAO = new ProductDAO();
                                    List<Product> productsList = proDAO.getProducts(c.getProductID());
                                    Product p = productsList.get(0);
                                    out.println("<li class='list-group-item d-flex justify-content-between lh-condensed'><div>");
                                    out.println("<h6 class='my-0'>");
                                    ...
                                    out.println("<span class='text-muted'>$");
                                    out.println(p.getPrice());
                                    out.println("</span>");
                                    out.println("<a href='removeCartItem?cartid=");
